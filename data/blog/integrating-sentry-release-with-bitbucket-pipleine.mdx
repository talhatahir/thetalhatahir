...
Now the next step is to pass the auto-generated BITBUCKET*BUILD_NUMBER to your React build compile command. In this way you are able to provide the bitbucket build number to your \_Sentry.init* function.
...
**Note:** \_argument\_ is used to define the environment : production, staging, development.
