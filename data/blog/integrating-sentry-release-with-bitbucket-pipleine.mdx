...
summary: 'Integrate Sentry releases with React using BitBucket pipelines to identify bugs and issues quickly in your release and patch them up.'
images:
  ['https://images.unsplash.com/photo-1516259762381-22954d7d3ad2?auto=format&fit=crop&w=1161&q=80']
---

![Photo by [Max Chen](https://unsplash.com/@maxchen2k?utm_source=medium&utm_medium=referral) on [Unsplash](https://unsplash.com?utm_source=medium&utm_medium=referral)](https://images.unsplash.com/photo-1516259762381-22954d7d3ad2?auto=format&fit=crop&w=1161&q=80)
...
![Photo from medium](https://cdn-images-1.medium.com/max/2488/1*Wz04-EBIuLyQu22qKfSD8Q.png)
