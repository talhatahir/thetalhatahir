...
images: ['https://unsplash.com/@flowforfrank']
---

![Photo by [Ferenc Almasi](https://unsplash.com/@flowforfrank?utm_source=medium&utm_medium=referral) on [Unsplash](https://unsplash.com?utm_source=medium&utm_medium=referral)](https://cdn-images-1.medium.com/max/9904/0*gGdy3kErPBSblTqs)
...
The best source recommended by **Professionals **to learn all these concepts is

[Mozilla Javascript Docs](https://developer.mozilla.org/en-US/docs/Web/JavaScript)
[**JavaScript**
*JavaScript (JS) is a lightweight, interpreted, or just-in-time compiled programming language with first-class…*developer.mozilla.org](https://developer.mozilla.org/en-US/docs/Web/JavaScript)
...
I am dividing the list of React concepts in two parts , *Basic *and _Advanced:_
